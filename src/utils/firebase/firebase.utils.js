...
const firebaseConfig = {
  ...
  export const addCollectionAndDocuments = async (collectionKey, objectsToAdd) => {
    const collectionRef = collection(db, collectionKey); //now we have the ref what are we going to do with this?
  ...
  export const getCategoriesAndDocuments = async () => {
    ...
    const categoryMap = querySnapshot.docs.reduce((acc, docSnapshot) => { // we get our actual category map that we've been building out
